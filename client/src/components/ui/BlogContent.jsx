...
const BlogContent = ({ block }) => {
    ...
    if (type == "header") {
        if (data.level == 3) {
            return <h3 className='text-xl font-semibold underline' dangerouslySetInnerHTML={{__html:data.text }}></h3>
        }
        return <h2 className='text-2xl mt-3 font-bold' dangerouslySetInnerHTML={{__html:data.text }}></h2>
